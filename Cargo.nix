    ...
    crates = {
      ...
      "gen-macros" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "3848232483a021c0cfeeb5953a2f06537769416c";
          sha256 = "1z48g6ymx0hshag4hlywa96xh36zhxn9nw6dc3dx81yrl2k6xlsv";
        };
        procMacro = true;
        libName = "gen_macros";
        authors = [
      ...
      "shikumi" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "4426f572b66d053dde2ca211c3b55121d76598b1";
          sha256 = "1jkf874jxcx5zclq3i1913nbpd822ly0vwbwy4xxgm3fmg3m06nn";
        };
        dependencies = [
          {
            name = "arc-swap";
      ...
      "todoku" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "a4cf19b6fc00f176fc44ba8087147360147f5d89";
          sha256 = "181128ziwc7ndlvc8lw0hf14bylk5rniilna2jz25x1qqgk79pcj";
        };
        dependencies = [
          {
            name = "async-trait";
