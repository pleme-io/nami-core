    ...
    crates = {
      ...
      "todoku" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "f27da70b365caf5d2eac25e461e817316e5f160a";
      ...
      "wasm-encoder 0.250.0" = rec {
        crateName = "wasm-encoder";
        version = "0.250.0";
        edition = "2024";
        sha256 = "08q94x2bwr9v9m096vbkdnhlxhrcw3xg2q2466plcc02csvssw92";
        libName = "wasm_encoder";
        authors = [
          "Nick Fitzgerald <fitzgen@gmail.com>"
        ];
      ...
      "wasmparser 0.250.0" = rec {
        crateName = "wasmparser";
        version = "0.250.0";
        edition = "2024";
        sha256 = "0mimsdfpi09rkljx17b0insl1acq69n5002ms0z604c1zg6rj787";
        authors = [
          "Yury Delendik <ydelendik@mozilla.com>"
        ];
        dependencies = [
      ...
      "wast 250.0.0" = rec {
        ...
        version = "250.0.0";
        edition = "2024";
        sha256 = "0jhg5560sf1rx7rw862ri76g6gpl2xaid5byqjssw1023x52ksb9";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
          ...
          {
            name = "wasm-encoder";
            packageId = "wasm-encoder 0.250.0";
            usesDefaultFeatures = false;
            features = [ "std" ];
          }
        ];
      ...
      "wat" = rec {
        ...
        version = "1.250.0";
        edition = "2024";
        sha256 = "00pxz8j94hkfw5h9zpnx63phlzd8n8d3k5kp1x7483m7579rwm0a";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
